...
/**
 * Created by gwenandbart on 12/05/16.
 */
public class JSONAdapter extends BaseAdapter {
    ...
    // answers the question: how long does the listview need to be
    @Override
    public int getCount() {
    ...
    // What should I show at Position X
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // skip all the expensive inflation/findviewbyid etc.
        ...
        // Grab the book title and author from the JSON
        String bookTitle = "";
        String authorName = "";
